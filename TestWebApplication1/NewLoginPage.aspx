<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewLoginPage.aspx.cs" Inherits="TestWebApplication1.NewLoginPage" %>
...
<body>
    <div class="container centered-form">
        <form runat="server">
            ...
            <a href="#" data-toggle="modal" style="text-align: center; display: block; margin: auto; margin-top:10px" id="exampleModalLabel" data-target="#exampleModal" runat="server">Joining Form</a>
            <!-- Modal -->
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
                                <div class="mb-3">
                                    <label for="TextBox6" class="form-label">Verify Email</label>
                                    <asp:Button ID="Button3" runat="server" Text="Verify" class="btn btn-outline-dark w-100 mt-3" OnClick="Button3_Click" />          
                                   
                                    <asp:TextBox ID="TextBox9" runat="server" placeholder="Enter OTP" Height="45px" Width="100%" CssClass="form-control"></asp:TextBox>
